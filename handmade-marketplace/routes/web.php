...
Route::middleware(['auth', 'seller'])
    ...
    ->group(function () {
        ...
        Route::view('/orders', 'seller.placeholders.coming-soon', ['title' => 'Orders', 'module' => 'Orders'])->name('orders.index');
...
Route::middleware(['auth', 'admin'])
    ...
    ->group(function () {
        ...
        Route::view('/orders', 'admin.placeholders.coming-soon', ['title' => 'Orders', 'module' => 'Order management'])->name('orders.index');
